function [s_t, log_trajectory_probability] = viterbi2(o_t, model)
...
for i = 1:model.nstates
  ...
  log_delta_it(i,1) = model.logPi(i) + model.states{i}.log_emission_probability(o_t(1,1)) ...
...
for t = 2:T
  for j = 1:model.nstates
    ...
    log_delta_it(j,t) = log_valmax + model.states{j}.log_emission_probability(o_t(1,t)) ...
